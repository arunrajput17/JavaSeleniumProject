...
public class A2_TestNGXMLExample {
	
	@Test(priority=1)
	public void setup()
	{
		System.out.println("This is A2_TestNGXMLExample setup test - Opening browser");
	}
	
	@Test(priority=2)
	void login()
	{
		System.out.println("This is A2_TestNGXMLExample login test");
	...
	void teardown()
	{
		System.out.println("This is A2_TestNGXMLExample Closing browser");
	}
